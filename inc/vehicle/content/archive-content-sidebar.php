<div class="col-lg-6 col-md-6 col-sm-12 item">
    <div class="product-card <?php echo Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_auction_or_not') == 'auction_product' ? 'auction' : '' ?>">
        <div class="product-img">
            ...
            if (!empty(Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_exterior_gallery'))) : ?>
                <div id="<?php echo esc_attr($id) ?>" class="hidden">
                    <?php
                    $i = 0;
            ...
            <div class="number-of-img">
                <a href="#<?php echo esc_attr($id) ?>" class="btn-gallery"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home1/icon/gallery-icon-1.svg') ?>" alt="<?php echo esc_attr('features-img', 'drivco') ?>"><?php echo esc_html($i) ?></a>
            </div>
            ...
            ?>
                <?php if ($_product && method_exists($_product, 'get_seconds_remaining')) : ?>
        ...
        <div class="product-content">
            ...
            <div class="price-location">
                ...
                <div class="location">
                    <?php echo Egns_Core\Egns_Helper::term_with_link('bi bi-geo-alt', 'location', 1) ?>
                </div>
            </div>
            <ul class="features">
                <li>
                ...
                <li>
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home4/icon/fuel.svg')  ?>" alt="<?php esc_html__('fuel-img', 'drivco') ?>">
                    <?php echo Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_type_info_value') ?>
                </li>
                <li>
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home4/icon/electric.svg')  ?>" alt="<?php esc_html__('electric-img', 'drivco') ?>">
            ...
            <div class="content-btm">
                <a class="view-btn2" href="<?php the_permalink() ?>">
                    ...
                    <?php echo esc_html__('Buy now', 'drivco') ?>
                </a>
                <div class="brand">
                    <a href="<?php echo Egns_Core\Egns_Helper::get_any_term_link('vehicle-brand') ?> ">
                        <img src="<?php echo Egns_Core\Egns_Helper::egns_vehicle_brand_taxonomy('drivco_brand_logo', 'url') ?>" alt="<?php echo esc_attr('brand-img', 'drivco') ?>">
                    </a>
                </div>
            </div>
        </div>
