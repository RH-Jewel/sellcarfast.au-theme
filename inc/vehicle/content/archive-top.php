<?php
$count_posts = !empty( $params['vehicle_count'] ) ? $params['vehicle_count'] : wp_count_posts('vehicle')->publish ;
?>

<div class="row mb-40">
    <div class="col-lg-12">
        <div class="show-item-and-filte">
            <p> <?php echo sprintf( __( 'Showing <strong> %d </strong> car available in stock','drivco' ), $count_posts ) ?> </p>
            <div class="filter-view d-xl-flex d-none">
                <div class="view">
