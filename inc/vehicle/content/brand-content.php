    ...
    <div class="product-card">
        <div class="product-img">
            ...
            <div class="number-of-img">
                <a href="#<?php echo esc_attr($id) ?>" class="btn-gallery"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home1/icon/gallery-icon-1.svg') ?>" alt="<?php esc_html__('cart-img', 'drivco') ?>"><?php echo esc_html($i) ?></a>
            </div>
        </div>
        <div class="product-content">
            ...
            <ul class="features">
                <li>
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home4/icon/menual.svg')  ?>" alt="<?php esc_html__('cart-img', 'drivco') ?>">
                    <?php echo Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_milage_info_value') ?>
                </li>
                <li>
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home4/icon/fuel.svg')  ?>" alt="<?php esc_html__('cart-img', 'drivco') ?>">
                    <?php echo Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_type_info_value') ?>
                </li>
                <li>
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home4/icon/electric.svg')  ?>" alt="<?php esc_html__('cart-img', 'drivco') ?>">
            ...
            <div class="content-btm">
                <a class="view-btn2" href="<?php the_permalink() ?>">
                    ...
                    <?php echo esc_html__('View Details', 'drivco') ?>
                </a>

                <div class="brand">
                    <a href="<?php echo Egns_Core\Egns_Helper::get_any_term_link('vehicle-brand') ?> ">
                        <img src="<?php echo Egns_Core\Egns_Helper::egns_vehicle_brand_taxonomy('drivco_brand_logo', 'url') ?>"alt="<?php echo esc_attr__('brand', 'drivco') ?>">
                    </a>
                </div>
            </div>
        </div>
