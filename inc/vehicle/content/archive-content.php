        ...
        <div class="product-img">
            ...
            if (!empty(Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_exterior_gallery'))) : ?>
                ...
                <div class="number-of-img">
                    <a href="#<?php echo esc_attr($id) ?>" class="btn-gallery"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/home1/icon/gallery-icon-1.svg') ?>" alt="<?php esc_html__('image', 'drivco') ?>"><?php echo esc_html($i) ?></a>
                </div>
            <?php endif; ?>
        ...
        <div class="product-content">
            ...
            <div class="content-btm">
                <a class="view-btn2" href="<?php the_permalink() ?>">
                    ...
                    <?php echo esc_html__('Bid Now', 'drivco') ?>
                </a>

                <div class="brand">
                    <a href="<?php echo Egns_Core\Egns_Helper::get_any_term_link('vehicle-brand') ?> ">
                        <img src="<?php echo Egns_Core\Egns_Helper::egns_vehicle_brand_taxonomy('drivco_brand_logo', 'url') ?>" alt="image">
                    </a>
                </div>
            </div>
        </div>
