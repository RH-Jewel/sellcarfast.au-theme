<div class="search-bar">
    ...
    <?php echo do_shortcode('[egns_general_filter style=2 advance=disabled]') ?>
</div>

<?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_sell_form'))) : ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo do_shortcode(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_sell_form')); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="header-and-filter-area">
    <header class="header-area style-3">
        <div class="header-logo">
            <?php
            if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_three_logo', 'url'))) {
                Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_three_logo', 'url'));
            } else {
        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <?php
                    if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_three_logo_mobile', 'url'))) {
                        Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_three_logo_mobile', 'url'));
                    } else {
            ...
            <!-- Main Menu -->
            <?php Egns\Helper\Egns_Helper::egns_get_theme_menu('primary-menu', 'pri-menu', '<i class="bi bi-plus dropdown-icon"></i>', 'menu-list', 3); ?>

            <div class="topbar-right d-lg-none d-block">

                <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_sell_show') == true) : ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_sell_label'))) : ?>
                        <button class="sell-btn" type="button" data-bs-toggle="modal" data-bs-target="#sellUsModal01">
                            ...
                            <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_sell_label') ?>
                        </button>
                    <?php endif; ?>
                <?php endif; ?>

                <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_wishlist_show') == true) : ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_wishlist_label')) && class_exists('WooCommerce') && defined('YITH_WCWL') && !function_exists('yith_wcwl_add_wishlist_to_loop')) : ?>
                        <a href="<?php echo esc_url(YITH_WCWL()->get_wishlist_url()) ?>">
                            ...
                            <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_wishlist_label') ?>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>

                <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_signIn_show') == true) : ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_signIn_label'))) : ?>
                        ...
                        <?php else : ?>
                            <a class="primary-btn3" href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">
                                ...
                                <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_signIn_label') ?>
                            </a>
                        <?php endif ?>
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_button_enable') == true) : ?>
                <div class="hotline-area d-lg-none d-flex">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_icon'))) : ?>
                        <div class="icon">
                            <img src="<?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_icon', 'url') ?>" alt="<?php esc_html__('review-logo', 'drivco') ?>">
                        </div>
                    <?php endif; ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_type'))) : ?>
                        <div class="content">
                            <span><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_head_label') ?></span>
                            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_type') == 'number') : ?>
                                <h6><a href="tel:<?php echo str_replace([' ', '-', '+'], '', esc_attr(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_label'))) ?>"><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_label') ?></a></h6>
                            <?php elseif (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_type') == 'mail') : ?>
                                <h6><a href="mailto:<?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_label') ?>"><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_label') ?></a></h6>
                            <?php else : ?>
                                <h6><span><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_contact_label') ?></span></h6>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_search_filter_show') || Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_button_enable'))) : ?>
        <div class="filter-area d-xl-flex d-none">

            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_search_filter_show') == true) : ?>
