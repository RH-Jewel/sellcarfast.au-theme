<?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_sell_form'))) : ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo do_shortcode(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_sell_form')); ?>
                </div>
            </div>
        </div>
    </div>
...
<div class="top-bar style-5">
    <div class="logo-and-menu">
        <div class="company-logo">
            <?php
            if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_five_logo', 'url'))) {
                Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_five_logo', 'url'));
            } else {
        ...
        <!-- Topbar Menu -->
        <?php Egns\Helper\Egns_Helper::egns_get_theme_menu('topbar-menu', 'menu', '', 'ul', 1); ?>
    ...
    <div class="topbar-right">
        <ul>
            ...
            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_sell_show') == true) : ?>
                <li class="d-xl-flex d-none">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_sell_label'))) : ?>
                        <button class="sell-btn" type="button" data-bs-toggle="modal" data-bs-target="#sellUsModal01">
                            ...
                            <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_sell_label') ?>
                        </button>
                    <?php endif; ?>
                </li>
            <?php endif; ?>

            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_wishlist_show') == true) : ?>
                <li>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_wishlist_label')) && class_exists('WooCommerce') && defined('YITH_WCWL') && !function_exists('yith_wcwl_add_wishlist_to_loop')) : ?>
                        <a href="<?php echo esc_url(YITH_WCWL()->get_wishlist_url()) ?>">
                            ...
                            <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_wishlist_label') ?>
                        </a>
                    <?php endif; ?>
                </li>
            <?php endif; ?>
            ...
            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_button_enable') == true) : ?>
                <li>
                    <div class="hotline-area d-xl-flex d-none">
                        <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_icon'))) : ?>
                            <div class="icon">
                                <img src="<?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_icon', 'url') ?>" alt="<?php esc_html__('icon', 'drivco') ?>">
                            </div>
                        <?php endif; ?>
                        <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_type'))) : ?>
                            <div class="content">
                                <span><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_head_label') ?></span>
                                <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_type') == 'number') : ?>
                                    <h6><a href="tel:<?php echo str_replace([' ', '-', '+'], '', esc_attr(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_label'))) ?>"><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_label') ?></a></h6>
                                <?php elseif (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_type') == 'mail') : ?>
                                    <h6><a href="mailto:<?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_label') ?>"><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_label') ?></a></h6>
                                <?php else : ?>
                                    <h6><span><?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_contact_label') ?></span></h6>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
...
<header class="header-area style-5">
    ...
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <?php
                if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_five_logo_mobile', 'url'))) {
                    Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_five_logo_mobile', 'url'));
                } else {
        ...
        <!-- Main Menu -->
        <?php Egns\Helper\Egns_Helper::egns_get_theme_menu('primary-menu', 'main-list', '<i class="bi bi-plus dropdown-icon"></i>', 'menu-list', 3); ?>
        ...
        <div class="topbar-right d-lg-none d-block">
            ...
            <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_signIn_show') == true) : ?>
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_signIn_label'))) : ?>
                    ...
                    <?php else : ?>
                        <a class="primary-btn3" href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">
                            ...
                            <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_signIn_label') ?>
                        </a>
                    <?php endif ?>
                <?php endif; ?>
            <?php endif; ?>
    ...
    <div class="nav-right d-flex jsutify-content-end align-items-center">
        ...
        <?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_cart_show') == true) : ?>
            <!-- Button trigger modal -->
            <div class="dropdown">
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_cart_label')) && class_exists('WooCommerce')) : ?>
                    <button class="modal-btn header-cart-btn" type="button">
                        <i class="bi bi-bag-check"></i> <?php echo Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_cart_label') . ' (' . WC()->cart->get_cart_contents_count() . ')' ?>
                    </button>
                <?php endif; ?>
