...
function egns_register_required_plugins()
{
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html('Drivco Core'),
			'slug'               => 'drivco-core',
			'source'             => esc_url('https://demo.egenslab.com/wp/plugins/drivco-wp/drivco-core.zip?v=1.2.0'),
			'required'           => true,
			'version'            => '1.2.0',
		...
		array(
			'name'               => esc_html('Simple Auctions'),
			'slug'               => 'woocommerce-simple-auctions',
			'source'             => esc_url('https://demo.egenslab.com/wp/plugins/global/woocommerce-simple-auctions.zip'),
			'required'           => true,
			'version'            => '',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			'name'         => esc_html('WooCommerce Wishlist'),
