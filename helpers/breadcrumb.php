...
if (!function_exists('egns_breadcrumb')) {
    ...
    function egns_breadcrumb($list_style = 'ul', $list_id = 'breadcrumb-list', $list_class = 'breadcrumb-list', $active_class = 'active', $echo = true)
    {
        ...
        // Search
        if (is_search()) {
            $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__('Search', 'drivco') . '</li>';
        }

        // 404
        if (is_404()) {
            $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__('404', 'drivco') . '</li>';
        }
        ...
        // Ouput
        if ($echo) {
            echo sprintf(esc_html__("%s", 'drivco'), $breadcrumb);;
        } else {
            return $breadcrumb;
        }
    }
